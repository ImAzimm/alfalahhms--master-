            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <section class="row g-3">
                        <h4 class="strong-title">Diagnosis Report Details</h4>
                        <div class="col-md-12">
                            <label for="doctor" class="form-label">Doctor Name</label>
                            <input id="doctor" class="form-control" type="text" value="Dr Husin" disabled>
                        </div>   
                        <div class="col-md-12">
                            <label for="recorder" class="form-label">Recorded By</label>
                            <input id="recorder" class="form-control" type="text" value="Harith Azdy" disabled>
                        </div>   
                        <div class="col-md-12">
                            <label for="date" class="form-label">Upload Date</label>
                            <input id="date" class="form-control" type="text" value="{{Date::now()}}" disabled>
                        </div>
                        <div class="col-md-12">
                            <label for="" class="form-label">Diagnosed File Report</label>

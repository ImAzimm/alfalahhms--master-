                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="machineName" class="form-select" name="machineName" required>
                                ...
                                <option>HMD-001</option>
                                <option>HMD-XYS</option>
                                <option>HMD-0LD</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="dialysisDuration" class="form-label">Dialysis Duration (hours)</label>
                            <input type="text" class="form-control" id="dialysisDuration" name="dialysisDuration" required>
                        </div>
                        <div class="col-md-6">
                            <label for="ufTarget" class="form-label">UF Target</label>
                            <input type="text" class="form-control" id="ufTarget" name="ufTarget" required>
                        </div>
                        <div class="col-md-6">
                            <label for="preTemperature" class="form-label">Pre-Temperature (°C)</label>
                            <input type="number" class="form-control" id="preTemperature" name="preTemperature" min="35" max="42" required>
                        </div>
                        <div class="col-md-6">
                            <label for="bloodFlow" class="form-label">Blood Flow (ml/min)</label>
                            <input type="number" class="form-control" id="bloodFlow" name="bloodFlow" min="200" required>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="preWeight" name="preWeight" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="postWeight" class="form-label" style="font-size: 0.8rem">Post</label>
                                    <input type="number" class="form-control" id="postWeight" name="postWeight" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="dialyserType" name="dialyserType" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="dialyserUsage" class="form-label" style="font-size: 0.8rem">Usage</label>
                                    <input type="text" class="form-control" id="dialyserUsage" name="dialyserUsage" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="preBP" name="preBP" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="prePulse" class="form-label" style="font-size: 0.8rem">Pulse</label>
                                    <input type="text" class="form-control" id="prePulse" name="prePulse" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="postBP" name="postBP" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="postPulse" class="form-label" style="font-size: 0.8rem">Pulse</label>
                                    <input type="text" class="form-control" id="postPulse" name="postPulse" required >
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="needleSize" class="form-label">Access/Needle Size</label>
                            <input type="text" class="form-control" id="needleSize" name="needleSize" required>
                        </div>
                        <div class="col-md-6">
                            <label for="heparinBolus" class="form-label">Heparin Bolus/Hourly</label>
                            <input type="text" class="form-control" id="heparinBolus" name="heparinBolus" required>
                        </div>
                        <div class="col-md-6">
                            <label for="KTV" class="form-label">KT/V</label>
                            <input type="text" class="form-control" id="KTV" name="KTV" required>
                        </div>
                        <div class="col-md-6">
                            <label for="EPO" class="form-label">EPO (ERYSAA)</label>
                            <select id="patient" class="form-select" required>
                                <option selected disabled>Choose EPO...</option>
                                <option>EPO 1</option>
                                <option>EPO 2</option>
                                <option>EPO 3</option>
                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="remarks" style="display:none" id="remarks"></textarea>
                        </div>
